		...
		<div class="col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6
			...
			<form action="${pageContext.request.contextPath}/veiculo/editar?id=<%= veiculo.get(0).getInt("id") %>"
				...
				<div class="form-group">
					...
					data-toggle="tooltip" 
					data-placement="bottom" title="Não é possível alterar o modelo">
				</div>
				...
				<div class="form-group">
					...
					data-toggle="tooltip" 
					data-placement="bottom" title="Não é possível alterar a placa">
				</div>
				...
				<div class="form-group">
					...
					title="Não é possível alterar a quantidade de vagas">
				</div>
